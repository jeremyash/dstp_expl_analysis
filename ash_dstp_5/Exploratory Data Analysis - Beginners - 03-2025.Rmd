...
This notebook analyzes data of adult diabetes rates at the county-level by socioeconomic markers such as metro areas, persistent poverty, and income.  We use data derived from the Food Environment Atlas to create summary statistics, scatter plots, histograms, and correlations to draw conclusions about adult diabetes.  
